...
Consider we have data points $f_i = f(x_i), i = 1,..,n$ and would like to 
find a polynomial passing through those points. In fluid simulations, for instance,
...
\subsubsection{Evaluating polynomials efficiently - Horner schema}
