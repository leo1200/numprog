...
The cases are illustrated in Fig. \ref{fig:float_cases}, with a specific example in Fig. \ref{fig:523float}.
...
\begin{equation}
    fl(x) = \frac{1}{1+\delta}, \quad |\delta| \leq \epsilon_{\text{mach}}
\end{equation}
