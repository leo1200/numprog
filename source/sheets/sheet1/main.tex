...
% toggle all solutions with \showsolutionstrue / \showsolutionsfalse
\newif\ifshowsolutions
\showsolutionstrue % set to true to display solutions
\NewEnviron{solutionblock}{\ifshowsolutions\solution\BODY\fi}
