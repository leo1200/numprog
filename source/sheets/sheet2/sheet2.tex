...
\usepackage{titling}  % provides \thetitle for use in headers
\pagestyle{fancy}
\makeatletter
\newcommand{\headtitle}{\@title}
\makeatother
% \fancyhead[R]{\thepage}
\fancyhead[L]{\headtitle}
% \cfoot{}

% % Ensure plain pages (e.g., after \maketitle) use the same header
...
\showsolutionsfalse % or \showsolutionsfalse
\ifshowsolutions
  % SHOW solutions
  \newenvironment{solutionblock}
    ...
    {}
\else
  % HIDE solutions (verbatim-safe)
  \excludecomment{solutionblock}
\fi
...
\pagestyle{plain}
{\noindent\Huge\bf  \\[0.5\baselineskip] {\fontfamily{cmr}\selectfont  Problem Set 2}}\\[2\baselineskip]
{ {\bf \fontfamily{cmr}\selectfont Fundamentals of Numerical Programming I}\\
{\textsc{Leonard Storcks}} \\
{\textit{\fontfamily{cmr}\selectfont     \today}}}
\\[1.4\baselineskip] 

% ====== Tasks ======

\import{tasks/}{1-tridiag.tex}
\import{tasks/}{2-jacobi.tex}
\import{tasks/}{3-errors.tex}
\import{tasks/}{4-regression.tex}
